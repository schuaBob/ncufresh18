var quiz = [
    ...
    { q: '凌晨3點有開的早餐店為?', o: ['萊姆思','達啵廚房','哈堡堡','惟客'] , correctIndex:3},
    { q: '校內有7-11嗎?', o: ['有','沒有','以上皆是','以上皆非'] , correctIndex:1},
    { q: '中央大學郵局在?', o: ['男9旁','男7旁','女4旁','女14旁'] , correctIndex:3},
    { q: '想買二手教科書可到?', o: ['敦煌書局','全家超商','581生活館','龍誠影印店'] , correctIndex:0},
    ...
    { q: '郵局平日營業時間為?', o: ['9:30~18:00','8:30~17:00','10:30~17:00','9:00~18:00'] , correctIndex:1},
    ...
    { q: '請問107學年度，中央大學的FB社團名稱為何?', o: ['2018 站在夢想的中央','2018 嶄．望 中央大學','2018邂逅中央','中大自由年代'] , correctIndex:2},
